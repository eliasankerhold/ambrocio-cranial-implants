...
ref_skull_path = os.path.join('reference_skull', 'Standard_Skull_A0035_topOnly_flattened_smoothed.stl')
processed_ref_skull_path = os.path.join('exports', 'reference_skull_auto_prepared_smoothing.stl')
